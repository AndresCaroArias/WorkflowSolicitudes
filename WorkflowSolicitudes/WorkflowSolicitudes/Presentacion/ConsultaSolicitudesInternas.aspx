<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ConsultaSolicitudesInternas.aspx.cs" Inherits="WorkflowSolicitudes.Presentacion.ConsultaSolicitudesInternas" %>
...
<div class ="row-fluid">
<div class ="span12"><h3 class="text-center">Consulta de Solicitudes Internas</h3></div>
</div>
...
<div class ="row-fluid">
<div class ="span4">  <asp:ImageButton ID="BtnBuscar" runat="server" Height="41px" 
...
<div class ="row-fluid">
<div class ="span6"><p class="text-left">Exportar a Excel:</p><asp:ImageButton ID="BtnExcel" runat="server" ImageUrl="~/imagenes/icon-excel.gif" onclick="BtnExcel_Click" /></div>
<div class ="span6"></div>
