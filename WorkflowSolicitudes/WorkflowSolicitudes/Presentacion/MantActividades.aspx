...
<div class ="row-fluid">
<div class ="span12">
    <asp:GridView ID="grvActividad" runat="server" AutoGenerateColumns="False" 
            BackColor="White" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" 
            CellPadding="3" ForeColor="Black" GridLines="Vertical" 
            onpageindexchanging="grvActividad_PageIndexChanging" 
            onrowdeleting="grvActividad_RowDeleting" onrowediting="grvActividad_RowEditing" 
            onrowupdating="grvActividad_RowUpdating" DataKeyNames="intCodActividad" 
